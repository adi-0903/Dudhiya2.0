...
import { getCollections, generateProRataFullReport } from '../../services/api';
...
const GenerateFullProRataReportScreen = ({ navigation }) => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const fileUri = await generateProRataFullReport(startDate, endDate);
...
export default GenerateFullProRataReportScreen;
