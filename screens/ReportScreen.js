...
const ReportScreen = () => {
  ...
  const handleNavigateToGenerateFullReportScreen = () => {
    navigation.navigate('GenerateFullReport');
  };

  const handleNavigateToFullCustomerReportScreen = () => {
    navigation.navigate('GenerateFullCustomerReport');
  };

  const handleNavigateToPurchaseReportScreen = () => {
    navigation.navigate('GeneratePurchaseReportScreen');
  };

  const handleNavigateToPurchaseSummaryReportScreen = () => {
    navigation.navigate('GeneratePurchaseSummaryReportScreen');
  };
