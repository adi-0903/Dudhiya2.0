...
import { getCollections, generateFullCustomerReport } from '../services/api';
...
const GenerateFullCustomerReportScreen = ({ navigation }) => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const fileUri = await generateFullCustomerReport(startDate, endDate);
...
export default GenerateFullCustomerReportScreen;
