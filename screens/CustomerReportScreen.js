...
import { getCustomerCollections, generateCustomerReport } from '../services/api';
...
const CustomerReportScreen = ({ route }) => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const fileUri = await generateCustomerReport(customerId, startDate, endDate);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTextContainer}>
          ...
          <Text style={styles.headerSubtitle}>{t('collection reports')}</Text>
        </View>
        <TouchableOpacity 
